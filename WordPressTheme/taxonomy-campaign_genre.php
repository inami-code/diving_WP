  ...
  <div class="sub-campaign__inner inner">
    <div class="sub-campaign__category sub-category">
      <div class="sub-category__items">
        <div class="sub-category__item"><a href="<?php echo get_post_type_archive_link('campaign') ?>">ALL</a></div>
          ...
          <div class="sub-category__item">
            <a class="<?php
                      if ($cat_name == esc_html($genre_term->name)) {
                        echo "is-active";
                      } ?>" href="<?php echo esc_url(get_term_link($genre_term, 'campaign_genre')); ?>"><?php echo esc_html($genre_term->name); ?></a>
          </div>
        <?php
        endforeach;
        ?>
