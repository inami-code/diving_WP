  ...
  <div class="sub-voice__inner inner">
    <div class="sub-voice__category sub-category">
      <div class="sub-category__items">
        <div class="sub-category__item"><a class="is-active" href="<?php echo get_post_type_archive_link('voice') ?>">ALL</a></div>
        <?php $genre_terms = get_terms('voice_genre', array('hide_empty' => false));
        foreach ($genre_terms as $genre_term) :
        ?>
          <div class="sub-category__item"><a href="<?php echo esc_url(get_term_link($genre_term, 'voice_genre')); ?>"><?php echo esc_html($genre_term->name); ?></a></div>
        <?php
        endforeach;
        ?>
      </div>
